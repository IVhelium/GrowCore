...
export default function UsersSearchPage() {
    ...
    async function handleSubmit(event) {
        ...
        const publicId = new FormData(event.currentTarget).get("public_id").trim().toUpperCase();
    ...
    return (
      <main>
        <Container className="py-8">
          ...
          {error && <p className="mt-6 max-w-xl rounded-lg bg-red-50 px-4 py-3 text-sm text-red-700">{error}</p>}
